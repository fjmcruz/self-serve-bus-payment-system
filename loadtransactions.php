...
<body onload=clock();>
    ...
    <div id="containerone">
        ...
        <form action="loadsearchaction.php" target="POPUP" onsubmit="POPUP=window.open('about:blank','POPUP','width=1400,height=600');">
        ...
        <div id="pagination">
            <?php
                if ($page > 1) {
                    echo "<a href='loadtransactions.php?page=".($page - 1)."'><</a>";
                }
                for ($i = max(1, $page - 5); $i <= min($page + 5, $totalpages); $i++) {
                    echo "<a href='loadtransactions.php?page=".$i."'";
